        ...
        <div class="container">
            <div class="regbox box">
                ...
                <form action="MedicineServlet" method="post">
                    ...
                    <p>Branch No</p>
                    <input type="text" placeholder="Branch No" name="branch" required>
                    <input type="submit" value="Add Medicine">
                    <a href="medTable.jsp"><button type="button" class="btn btn-primary btn-lg btn-block">View All Medicine</button></a>
